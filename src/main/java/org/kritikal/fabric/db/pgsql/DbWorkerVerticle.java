 ...
 */
public abstract class DbWorkerVerticle extends AbstractVerticle implements Handler<Message<JsonObject>> {
    ...
    public Connection connect(Configuration cfg) throws SQLException
    {
