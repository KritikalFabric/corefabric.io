 ...
 */
public final class DailyMetrics<T extends DbDataWarehouse> extends Period implements Time, MetricsBuilder<T> {

    public DailyMetrics(String tableName, java.sql.Timestamp today, T t) {
